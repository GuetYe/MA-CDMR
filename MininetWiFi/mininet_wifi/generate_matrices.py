...
if __name__ == '__main__':
    ...
    # 1.55 * 1e3 * 0.750
    parser.add_argument("--mean_traffic", default=200, help="mean volume of traffic (M/s)")
    parser.add_argument("--pm_ratio", default=2, help="peak-to-mean ratio")
    parser.add_argument("--t_ratio", default=0.2, help="trough-to-mean ratio")
